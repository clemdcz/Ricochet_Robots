...
public class MainController {
    ...
    public void initialize() {
       ...
       // boardPane.setBackground( new Background(new BackgroundFill(Color.BLACK,CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        // setup wall here
        getTileAt(0,4).setWall(true,false,false,false);
        getTileAt(0,10).setWall(true,false,false,false);
        ...
        getTileAt(2,15).setWall(false,false,true,false);
        ...
        getTileAt(4,15).setWall(true,false,false,false);


        getTileAt(5,0).setWall(false,false,true,false);
        ...
        getTileAt(11,0).setWall(false,false,true,false);
        ...
        getTileAt(12,15).setWall(false,false,true,false);
        ...
        getTileAt(13,15).setWall(true,false,false,false);

        getTileAt(14,4).setWall(true,false,false,false);
        getTileAt(14,10).setWall(true,false,true,false);

        getTileAt(15,3).setWall(false,false,true,false);
        getTileAt(15,5).setWall(true,false,false,false);
        getTileAt(15,12).setWall(true,false,false,false);
